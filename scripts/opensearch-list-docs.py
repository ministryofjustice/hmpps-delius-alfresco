#!/usr/bin/env python3
# opensearch-list-docs.py
#
# Lists all document IDs from an OpenSearch index using legacy Scroll API.
...
#
# Usage examples:
#   python3 opensearch-list-docs.py --url http://my-opensearch-host:9200
#   python3 opensearch-list-docs.py --method scroll --size 2000 --outfile ids.txt
#
...
# kubectl -n "$ns" exec "$pod" -- bash -lc "nohup python3 ./opensearch-list-docs.py --url $PROXY_URL &"
#
import argparse
import json
import sys
...
def main():
    ...
    parser.add_argument("--outfile", default="ids.txt", help="Output file for IDs")
